...
public class HoldTile : TilePiece
{
    ...
    {
        SinglePlayerTutorialPanel.s_TutorialEnds -= OnTutorialEnds;
        ViewSinglePlayerGame.s_RefreshHoldTilePlacement -= RefreshHoldTilePlacement;
    ...
    private void OnTutorialEnds()
    {
        ...
        m_XPressed = m_HoldTileInputs.SinglePlayer.StorePiece;
        m_XPressed.performed += StorePiece;
        m_XPressed.Enable();
