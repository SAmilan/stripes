...
public class UpcomingTilePlayer1 : TilePiece
{
    ...
    {
        m_UpcomingButtonTap = m_UpcomingButtonActions.TwoPlayers.UpcomingActionsPlayer1;
        m_UpcomingButtonTapGamepad = m_UpcomingButtonActions.TwoPlayers.UpcomingActionsPlayer1Gamepads;
        m_PlacePiece = m_UpcomingButtonActions.TwoPlayers.PlacePiecePlayer1;
        m_PlacePieceGamepad = m_UpcomingButtonActions.TwoPlayers.PlacePiecePlayer1Gamepads;
        ...
        ViewTwoPlayerGame.s_AutomaticTilePlaceCallback_Player1 += MovePiece;
        ViewTwoPlayerGame.s_ActiveUpcomingInputs_Player1 += EnableUpcomingInputs;
    ...
    private void MovePiece()
    {
        ...
        if (!m_isGameOver && !GameManager.instace.TwoPlayerGamePauseStatus && !GameManager.instace.FirstPlayerPauseStatus)
            moveAction?.Invoke();
    }
    ...
    private void MovePieceToGrid(InputAction.CallbackContext context)
    {
        ...
        // Debug.Log("Upcoming Next Position: " + nextPosition);
        Action moveAction = () =>
        {
    ...
    private void MovePieceToGridGamePad(InputAction.CallbackContext context)
    {
        ...
        if (!m_isGameOver && !GameManager.instace.TwoPlayerGamePauseStatus && !GameManager.instace.FirstPlayerPauseStatus)
        {
            ...
            {
                if (GamepadManager.Instance.m_Gamepad1.dpad.IsPressed() || GamepadManager.Instance.m_Gamepad1.leftStick.IsPressed())
                {
                    moveAction?.Invoke();
                }
            }
