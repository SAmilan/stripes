...
public class GridTilePlayer2 : TilePiece
{
    ...
    [SerializeField]
    private List<GridTilePlayer2> m_AttachedPiece = new List<GridTilePlayer2>();
    [SerializeField]
    private List<GridTilePlayer2> m_StartingPieceLoopPool = new List<GridTilePlayer2>();
    [SerializeField]
    ...
    public List<GridTilePlayer2> ContiniousFlowPieces = new List<GridTilePlayer2>();
    public int StartingPieceCounter => p_StartingPieceCounter;
    public List<GridTilePlayer2> StartingPieceLoopPool => m_StartingPieceLoopPool;
    [SerializeField]
    private List<GridTilePlayer2> m_PieceLoop = new List<GridTilePlayer2>();
    public List<GridTilePlayer2> PieceLoop => m_PieceLoop;
    private bool m_IsLoopCompleted;
    private bool m_StartedPieceCounted = false;
    public List<GridTilePlayer2> AttachedPiece => m_AttachedPiece;
    ...
    {
        ViewTwoPlayerGame.s_SetGridTilePosition_Player2 += SetGridPiecePosition;
        ViewTwoPlayerGame.s_SetUpcomingBombPositon_Player2 += SetUpcomingBombPosition;
        ViewTwoPlayerGame.s_ActiveTilePiece_Player2 += ActiveTilePiece;
        ViewTwoPlayerGame.s_DeActiveTilePiece_Player2 += DeActiveTilePiece;
        ViewTwoPlayerGame.s_PlaceTilePiece_Player2 += PlaceTilePiece;
        ViewTwoPlayerGame.s_ActiveBomb_Player2 += ActiveBomb;
        ViewTwoPlayerGame.s_PlaceBomb_Player2 += PlaceBombTwoPlayer;
        ViewTwoPlayerGame.s_CheckTileLeftVectorStatus_Player2 += CheckTileLeftStatus;
        ViewTwoPlayerGame.s_CheckTileRightVectorStatus_Player2 += CheckTileRightStatus;
        ViewTwoPlayerGame.s_CheckTileUPVectorStatus_Player2 += CheckTileUpStatus;
        ViewTwoPlayerGame.s_CheckTileDownVectorStatus_Player2 += CheckTileDownStatus;
        ViewTwoPlayerGame.s_SetStartingPositon_Player2 += SetStartingPiecePosition;
        ViewTwoPlayerGame.s_OnStartingPieceCounterChanges_Player2 += OnStartingPieceCounterChanges;
        ViewTwoPlayerGame.s_OnRoundObstacleSpawn_Player2 += CreateRoundObstacle;
        ViewTwoPlayerGame.s_OnHorizontalObstacleSpawn_Player2 += CreateHorizontalObstacle;
        ViewTwoPlayerGame.s_OnVerticalObstacleSpawn_Player2 += CreateVerticalObstacle;
        ViewTwoPlayerGame.s_CheckStartingPieceLoopStatus_Player2 += UpdateStartingPieceLoopStatus;
        ViewTwoPlayerGame.s_MidCounterLoopStatus_Player2 += CheckPieceLoopStatus;
        ViewTwoPlayerGame.s_CalculateDetachPieces_Player2 += CalculateDetachPieces;
        ViewTwoPlayerGame.s_OnGameOvers_Player2 += OnGameOvers;
        ViewTwoPlayerGame.s_StartingPieceCounted_Player2 += StartedPieceCounted;
        ViewTwoPlayerGame.s_SpawnNextStartingPiece_Player2 += CheckStartingPieceSafeArea;
        ViewTwoPlayerGame.s_SpawnStartingPiecePlayer2_Horizontal += CheckStartingPieceHorizontalSafeArea;
        ViewTwoPlayerGame.s_SpawnStartingPiecePlayer2_Vertical += CheckStartingPieceVerticalSafeArea;
        ViewTwoPlayerGame.s_CheckSafeAreaStatus_Player2 += StartingPieceSafeAreaStatus;
        ViewTwoPlayerGame.s_CheckStartingPieceHorizontalSafeAreaStatus_Player2 += StartingPieceHorizontalSafeAreaStatus;
        ViewTwoPlayerGame.s_CheckStartingPieceVerticalSafeAreaStatus_Player2 += StartingPieceVerticalSafeAreaStatus;
        ViewTwoPlayerGame.s_SpawnStartingPiece_Player2 += SpawnStartingPiece;
        ViewTwoPlayerGame.s_StartFlowAnimation_Player2 += StartFlowAnimation;
        ViewTwoPlayerGame.s_SetCurrentPiece_Player2 += SetPieceActive;
        ViewTwoPlayerGame.s_NextTileValidPosition_Player2 += ValidNextPosition;
        ViewTwoPlayerGame.s_LockLoopPiece_Playe2 += LockLoopPiece;
        ViewTwoPlayerGame.s_ResetStartingPiecePositions_Player2 += ResetStartingPiecePosition;
        ViewTwoPlayerGame.s_TriggerBrokenAnimation_Player2 += TriggerBrokenPieceAnimation;
        HoldTilePlayer2.s_StorePiece += HoldCurrentActivePiece;
        ViewTwoPlayerGame.s_StorePieceTriggered_Player2 += ResetTilePiece;
        ViewTwoPlayerGame.s_ResetCurrentPosition_Player2 += ResetCurrentPosition;
        ViewTwoPlayerGame.s_FlashStartingPiece_Player2 += FlashStartingPiece;
        ViewTwoPlayerGame.s_HandlContinuousFlowAnimation_Player2 += HandleContinousTileFlow;
        HoldTilePlayer2.s_ExtractPiece += ExtractHoldPiece;
        HoldTilePlayer2.s_CheckActiveTileStatus += CheckTileActiveStatus;
    ...
    private void Update()
    {
        ...
        HandleTileAntiClockwiseRotation();
    }
    ...
    private void HoldCurrentActivePiece(TilePiece currentHoldTile, Action<TilePiece> activeTilePiece, Action<Vector2> resetHoldTile)
    {
        if (m_isSelected || m_IsBomb)
        {
            ...
            {
                ExtractHoldPiece(SwapTilePlayer2.Instance);
                return;
            }
            else
            {
    ...
    private void ValidNextPosition(Vector2 gridPosition, Action<GridTilePlayer2> validTile)
    {
    ...
    private void HandleContinousTileFlow(Vector2 previousTile, Vector2 currentTile, Action<Vector2, Vector2> nextPieceCallback, Action<GridTilePlayer2, float> lastPieceCallback, Action<int, bool> incrementScoreCallback, GridTilePlayer2 startingPiece, Action<Vector2> resetStartingPosition, Action<GridTilePlayer2> loopCompleteCallback, float flowSpeed, Action onflowStarts)
    {
    ...
    private void StartingPieceHorizontalSafeAreaStatus(Vector2 currentPosition, List<GridTilePlayer2> loopPieces, Action<bool> pieceStatus)
    {
    ...
    private void StartingPieceVerticalSafeAreaStatus(Vector2 currentPosition, List<GridTilePlayer2> loopPieces, Action<bool> pieceStatus)
    {
        if (p_GridPosition == currentPosition)
        {
            int tileIndex = loopPieces.FindIndex(element => element.GridPosition == p_GridPosition);
    ...
    private void OnStartingPieceCounterChanges(Action<GridTilePlayer2> startingPiece, Action<GridTilePlayer2> loopCompletecallback, Action<bool> increaseTimer, int[] remainingTime, Action<GridTilePlayer2> FlowAnimationCallback)
    {
        Action startingPieceAction = () =>
        {
    ...
    {
        if (targetPiece == p_GridPosition && Player2)
        {
    ...
    private void DecrementStartingPieceCounter(Action<GridTilePlayer2> startingPiece, Action<GridTilePlayer2> loopCompleteCallback, Action<bool> increaseTimer, int[] remainingTime, Action<GridTilePlayer2> FlowAnimationCallback)
    {
    ...
    private void CheckStartingPieceHorizontalSafeArea(Action<Vector2, List<GridTilePlayer2>, Action<bool>> safeAreaStatusCallback, List<GridTilePlayer2> loopPieces, List<Vector2> spawnSpots)
    {
        if (m_Canplace)
        {
            int pieceCount = 0;
    ...
    private void CheckStartingPieceVerticalSafeArea(Action<Vector2, List<GridTilePlayer2>, Action<bool>> safeAreaStatusCallback, List<GridTilePlayer2> loopPieces, List<Vector2> spawnSpots)
    {
        if (m_Canplace)
        {
            int pieceCount = 0;
    ...
    private void CheckPieceLoopStatus(GridTilePlayer2 startingPiece, Vector2 NextPiecePosition, Vector2 flowVector, Action<GridTilePlayer2, Vector2, Vector2> SendNextAttachedPiece)
    {

        if (p_GridPosition == NextPiecePosition && transform.parent.name == Constants.MAINGAMEAREAPARENTTWOPLAYERS)
        {
            m_IsAttached = true;
            GridTilePlayer2 nextPiece = null;
    ...
    private void UpdateStartingPieceLoopStatus(GridTilePlayer2 startingPiece, Vector2 NextPiecePosition, Vector2 flowVector, Action<GridTilePlayer2, Vector2, Vector2> SendNextAttachedPiece)
    {
    ...
    private void CreateStartingPiece(int startingPieceIndex, int anglee)
    {
        ...
        m_Type = Constants.STARTING_TYPEPIECE;
        var startingPieceCounterValues = GameData.Instance.StartingPiecesIndex.Find(element => element.StartingPieceIndex == m_StartingPieceIndex);
        //p_StartingPieceCounter = startingPieceCounterValues.StartingPieceCounters[Random.Range(0, startingPieceCounterValues.StartingPieceCounters.Count)];
    ...
    {
        //keyboard conrols
        m_RotatePieceClockwise = m_TwoPlayerInputs.TwoPlayers.RotatePieceClockwisePlayer2;
        m_RotatePieceAntiClockwise = m_TwoPlayerInputs.TwoPlayers.RotatePieceAntiClockwisePlayer2;
    ...
    {
        // Turn this function On if needed the Clockwise Rotation
       /* Action RotateAction = () =>
        {
            SoundManager.Instance.PlayRotateTilePieceSoundPlayer2();
        ...
        /* if (!m_isGameOver)
         {
             ...
             {
                 if (GamepadManager.Instance.m_Gamepad2.rightTrigger.wasPressedThisFrame || GamepadManager.Instance.m_Gamepad2.rightShoulder.wasPressedThisFrame)
                 {
                     RotateTilePiece(-Constants.ANGLE_DIFF);
                 }
             }
    ...
    private void HandleTileAntiClockwiseRotation()
    {
        Action RotateAction = () =>
        {
            SoundManager.Instance.PlayRotateTilePieceSoundPlayer2();
        ...
        if (!m_isGameOver && m_isSelected)
        {
            if (GamepadManager.Instance.m_Gamepad2 != null)
            {
                if (GamepadManager.Instance.m_Gamepad2.bButton.wasPressedThisFrame || GamepadManager.Instance.m_Gamepad2.leftShoulder.wasPressedThisFrame || GamepadManager.Instance.m_Gamepad2.leftTrigger.wasPressedThisFrame)
                {
                    RotateAction?.Invoke();
                }
            }
        ...
        /* if (!m_isGameOver)
         {
             if (GamepadManager.Instance.m_Gamepad2 != null)
             {
                 if (GamepadManager.Instance.m_Gamepad2.leftTrigger.wasPressedThisFrame || GamepadManager.Instance.m_Gamepad2.leftShoulder.wasPressedThisFrame)
                 {
                     RotateTilePiece(Constants.ANGLE_DIFF);
                 }
             }
    ...
    private void AssignTilePieceCode(Vector2 currentPosition, double[] tileCodes, bool isPlayer1, bool isPlayer2)
    {
        ...
        if (currentPosition == GridPosition && isPlayer2)
            tileAction?.Invoke();
    }
    protected void CheckTileUpStatus(GridTilePlayer2 currentTile, Vector2 UpTilePosition)
    {
    ...
    protected void CheckTileDownStatus(GridTilePlayer2 currentTile, Vector2 DownTilePosition)
    {
    ...
    protected void CheckTileLeftStatus(GridTilePlayer2 currentTile, Vector2 leftTilePosition)
    {
    ...
    protected void CheckTileRightStatus(GridTilePlayer2 currentTile, Vector2 rightTilePosition)
    {
    ...
    private void CheckLoopPieces(List<GridTilePlayer2> loopPieces)
    {
        GridTilePlayer2 startingPiece = loopPieces.Find(element => element.IsStartingPiece);
        int startingPieceCount = 0;
        foreach (GridTilePlayer2 tile in loopPieces)
        {
    ...
    #region COROUTINES
    private IEnumerator ExplodeStarttingPiece(GridTilePlayer2 startingPiece, float time, Action<Vector2> startingPiecePosition)
    {
        ...
        for (int loopPieceIndex = Constants.INT_ZERO; loopPieceIndex < startingPiece.m_PieceLoop.Count; loopPieceIndex++)
        {
            ...
            if (!startingPiece.m_PieceLoop[loopPieceIndex].IsStartingPiece && !startingPiece.m_PieceLoop[loopPieceIndex].isSelected && !startingPiece.m_PieceLoop[loopPieceIndex].IsBomb)
            {
                startingPiece.m_PieceLoop[loopPieceIndex].m_isLoopPiece = false;
    ...
    private IEnumerator StartStartingPieceFillingFlowImageContiniousFlow(float time, GridTilePlayer2 startingPiece)
    {
        float startValue = Constants.INT_ZERO;
        float endValue = Constants.INT_ONE;
        float valueToLerp;
    ...
    private IEnumerator DecrementCounter(Action<GridTilePlayer2> startingPiece, Action<GridTilePlayer2> loopCompleteCallback, Action<bool> increaseTimer, int[] remainingTime, Action<GridTilePlayer2> FlowAnimationCallback)
    {
    ...
    private IEnumerator StartFillingContinousFlowForNextPosition(Action<Vector2, Vector2> nextPieceCallback, Action<GridTilePlayer2, float> lastPieceCallback, float time, GridTilePlayer2 startingPiece, Action<GridTilePlayer2> loopCompleteCallback, Action onflowStarts)
    {
        float startValue = Constants.INT_ZERO;
        float endValue = Constants.INT_ONE;
        float valueToLerp;
    ...
    private IEnumerator StartFillingContinousFlowForDualImage(Action<Vector2, Vector2> nextPieceCallback, Action<GridTilePlayer2, float> lastPieceCallback, float time, GridTilePlayer2 startingPiece, Action<GridTilePlayer2> loopCompleteCallback, Action onFlowStarts)
    {
        float startValue = Constants.INT_ZERO;
        float endValue = Constants.INT_ONE;
        float valueToLerp;
    ...
    private IEnumerator NextPieceAnimationAttachedPieceStatusForCrossPiece(Action<Vector2, Vector2> nextPieceCallback, Action<GridTilePlayer2, float> lastPieceCallback, float time)
    {
        ...
        GridTilePlayer2 nextTilePosition = m_AttachedPiece.Find(tile => tile.GridPosition == (p_GridPosition + crossPieceFlowVector));
    ...
    private IEnumerator NextPieceAnimationAttachedPieceStatus(Action<Vector2, Vector2> nextPieceCallback, Action<GridTilePlayer2, float> lastPieceCallback, float time)
    {
        yield return new WaitForSeconds(Constants.ZERO);
        GridTilePlayer2 nextTilePosition = m_AttachedPiece.Find(tile => tile.GridPosition != (p_GridPosition - m_StartingPieceFlowVector));
        if (nextTilePosition != null)
        {
            nextPieceCallback?.Invoke(p_GridPosition, nextTilePosition.GridPosition);
        }
    ...
    private IEnumerator ExplodeContiniousFlowPiece(GridTilePlayer2 startingPiece, float time, Action<Vector2> startingPiecePosition)
    {
        time = (startingPiece.m_IsLoopCompleted) ? Constants.INT_ONE / Constants.MAX_FLOWSPEED : time;
        yield return new WaitForSeconds(time + 0.3f);
