...
public class HoldTilePlayer2 : TilePiece
{
    ...
    {
        ViewTwoPlayerGame.s_RefreshHoldTilePlacement_Player2 -= RefreshHoldTilePlacement;
        TwoPlayerTutorialPanel.s_TutorialEnds -= OnTutorialEnds;
    ...
    private void OnTutorialEnds()
    {
        ...
        m_XPressed = m_HoldTileInputs.TwoPlayers.StorePiecePlayer2;
        m_XPressed.performed += StorePiece;
        m_XPressed.Enable();
    ...
    {
        if (GamepadManager.Instance.m_Gamepad2 != null && m_isGamePadActive)
        {
